...
Once you have everything ready, login into your Linux VM, try out Positron/RKWard, and also open QGIS. Explore the environment a little to get used to it.
...
In the top left of *Positron*, click *New*, then *New folder from Git...*, and paste the link you just copied into the "Git repository URL" box.
Select the directory you want to put the repository into under "Create folder as subfolder of".
A subdirectory with the name of the repository will be created for you inside the sected directory.
...
![Git GUI in an empty directory](figs/positron-clone.png)
...
![Changes pending in Git Cola](figs/positron-changes.png)
