...
You will see your files from GitLab copied locally to your computer at the top left of Positron:
...
Let's go back to Positron. If you closed the previous Positron window, you can get back to your repository by launching Positron and clicking on its path in the *list*. You will see some changes in the Source Control tab on the left side of the screen:
