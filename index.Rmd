...
* Finally, as you learned at the beginning of this tutorial, you should include a `LICENSE.txt` file with the software liscence which you would like your code to have. 
...
# Load datasets 
wageningen_ndvi <- st_read('data/wag_NDVI.gpkg')
