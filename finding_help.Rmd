...
Agentic models, where an LLM is allowed to do work as if it was a human, i.e. allowed to read your files, use a web browser, push changes to git, etc. are also gaining popularity for the productivity boost they provide.
